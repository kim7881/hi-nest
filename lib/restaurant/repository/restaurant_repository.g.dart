...
class _RestaurantRepository implements RestaurantRepository {
  ...
  Future<RestaurantDetailModel> getRestaurantDetail({required id}) async {
    ...
    final _headers = <String, dynamic>{
      r'authorization':
          'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6InRlc3RAY29kZWZhY3RvcnkuYWkiLCJzdWIiOiJmNTViMzJkMi00ZDY4LTRjMWUtYTNjYS1kYTlkN2QwZDkyZTUiLCJ0eXBlIjoiYWNjZXNzIiwiaWF0IjoxNjYxNzc3Nzk5LCJleHAiOjE2NjE3NzgwOTl9.Zsg8fCwNtu7lsY3Dle7h-tcvgHk46zvAJRAtc_gMisI'
    };
